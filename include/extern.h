...
E int FDECL(add_autoadjust_opt, (const char *) );
E void FDECL(get_item_match_name, (struct obj *, char[]));
E void NDECL(free_autopickup_exceptions);
E int FDECL(add_autoadjust, (char, enum autoadjust_type, const char *));
E void NDECL(free_autoadjust_entries);
